...
Personal preferences (communication style, commit conventions, naming, general engineering hygiene) live in user memory at `~/.Codex/AGENTS.md` and are not repeated here. This file contains only what is specific to this project.
