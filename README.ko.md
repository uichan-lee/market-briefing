...
```bash
uv sync                          # 의존성 설치
uv run pytest -m "not network"   # 기본 테스트 실행 — 719개
...
| 3 | 수집기 + 검증 테스트 | ✅ 수집기 7개, 오프라인 719 / 네트워크 12 |
